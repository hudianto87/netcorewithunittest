...
{
    public partial class TtransactionHistory
    {
        public TtransactionHistory()
        {
            TtransactionBankAccountHistories = new HashSet<TtransactionBankAccountHistory>();
        }
        ...
        public virtual ICollection<TtransactionBankAccountHistory> TtransactionBankAccountHistories { get; set; }
    }
}
