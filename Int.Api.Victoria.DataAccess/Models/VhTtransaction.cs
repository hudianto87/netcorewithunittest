...
{
    public partial class VhTtransaction
    {
        public string TrxUhl { get; set; } = null!;
        public string? TrxFullName { get; set; }
        public string TrxProductCode { get; set; } = null!;
        public string TrxProductName { get; set; } = null!;
        public string? SubAccountNo { get; set; }
        public string? SubAcProduct { get; set; }
        public string? SubAcUhl { get; set; }
