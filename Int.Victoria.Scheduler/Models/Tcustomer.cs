...
namespace Int.Victoria.Scheduler.Models
{
    public partial class Tcustomer
    {
        public Tcustomer()
        {
            ...
            TassetTransferFromIdcustomerNavigations = new HashSet<TassetTransfer>();
            TassetTransferToIdcustomerNavigations = new HashSet<TassetTransfer>();
            ...
            TcustomerAuthContacts = new HashSet<TcustomerAuthContact>();
            TcustomerBods = new HashSet<TcustomerBod>();
            TcustomerCardInformations = new HashSet<TcustomerCardInformation>();
            TcustomerCorporateCardHolders = new HashSet<TcustomerCorporateCardHolder>();
            TcustomerCustodies = new HashSet<TcustomerCustody>();
            TcustomerDocuments = new HashSet<TcustomerDocument>();
            TcustomerHeirs = new HashSet<TcustomerHeir>();
            TcustomerOwnerships = new HashSet<TcustomerOwnership>();
            TcustomerRegInvestmentPlans = new HashSet<TcustomerRegInvestmentPlan>();
            TcustomerRiskProfiles = new HashSet<TcustomerRiskProfile>();
            TcustomerSalesHistories = new HashSet<TcustomerSalesHistory>();
            TcustomerShareholders = new HashSet<TcustomerShareholder>();
            TextHighNetworkCustomers = new HashSet<TextHighNetworkCustomer>();
            Tgoals = new HashSet<Tgoal>();
            TinsuranceCovers = new HashSet<TinsuranceCover>();
            TproductBundlingRegistrations = new HashSet<TproductBundlingRegistration>();
            Tretirements = new HashSet<Tretirement>();
        ...
        /// <summary>
        /// Possible values are &quot;INDIVIDUAL&quot; AND &quot;CORPORATE&quot;
        /// </summary>
        ...
        public virtual TcustomerIndividual TcustomerIndividual { get; set; } = null!;
        public virtual TcustomerInstitusi TcustomerInstitusi { get; set; } = null!;
        public virtual ICollection<TagentCustomer> TagentCustomers { get; set; }
        public virtual ICollection<TassetTransfer> TassetTransferFromIdcustomerNavigations { get; set; }
        public virtual ICollection<TassetTransfer> TassetTransferToIdcustomerNavigations { get; set; }
        ...
        public virtual ICollection<TcustomerAuthContact> TcustomerAuthContacts { get; set; }
        public virtual ICollection<TcustomerBod> TcustomerBods { get; set; }
        public virtual ICollection<TcustomerCardInformation> TcustomerCardInformations { get; set; }
        public virtual ICollection<TcustomerCorporateCardHolder> TcustomerCorporateCardHolders { get; set; }
        public virtual ICollection<TcustomerCustody> TcustomerCustodies { get; set; }
        public virtual ICollection<TcustomerDocument> TcustomerDocuments { get; set; }
        public virtual ICollection<TcustomerHeir> TcustomerHeirs { get; set; }
        public virtual ICollection<TcustomerOwnership> TcustomerOwnerships { get; set; }
        public virtual ICollection<TcustomerRegInvestmentPlan> TcustomerRegInvestmentPlans { get; set; }
        public virtual ICollection<TcustomerRiskProfile> TcustomerRiskProfiles { get; set; }
        public virtual ICollection<TcustomerSalesHistory> TcustomerSalesHistories { get; set; }
        public virtual ICollection<TcustomerShareholder> TcustomerShareholders { get; set; }
        public virtual ICollection<TextHighNetworkCustomer> TextHighNetworkCustomers { get; set; }
        public virtual ICollection<Tgoal> Tgoals { get; set; }
        public virtual ICollection<TinsuranceCover> TinsuranceCovers { get; set; }
        public virtual ICollection<TproductBundlingRegistration> TproductBundlingRegistrations { get; set; }
        public virtual ICollection<Tretirement> Tretirements { get; set; }
